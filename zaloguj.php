...
<body>
    ...
    <main style="height: 160vh;">
        ...
        <div id="main">
            ...
            <p style="text-align: center; font-family: Joan; font-size: 18px; padding-top: 4%;">Masz już konto?<a style="color:#FFAC41" href="logowanie.php"> Zaloguj się</a></p>
            </form>
            <?php
                if(isset($_POST["register"])) {
                    ...
                    if($count>0) {
                        echo "<p style='text-align: center; font-family: Joan; font-size: 18px;'>Ta nazwa użytkownika jest już w użyciu!</p>";
                    }else {
                        $passwd = $_POST["passwd"];
                        ...
                        if(!$res) {
                            echo "<p style='text-align: center; font-family: Joan; font-size: 18px;'>Nie udało się zarejestrować użytkownika!</p>";
                        } else {
